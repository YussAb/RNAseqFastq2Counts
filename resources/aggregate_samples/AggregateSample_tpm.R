...
# Parameters
option_list = list(optparse::make_option(c("-f", "--folder"), type = "character", default = F, help = "folder containing the file tpm", metavar = ""),
...
#outputPath="/data/yabili/RNAseqFastq2Counts/xpo1_3rd_run_seq/04_normalized_counts/xpo1_3rd_tpm.tsv"
